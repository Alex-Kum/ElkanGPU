...
public:
    ...
    //virtual double pointPointInnerProduct_new(int x1, int x2) const = 0;
    //virtual double pointCenterInnerProduct_new(int xndx, unsigned short cndx) const = 0;
    //virtual double centerCenterInnerProduct_new(unsigned short c1, unsigned short c2) const = 0;
...
protected:
    ...
    //virtual void changeAssignment_new(int xIndex, int newCluster, int threadId);
